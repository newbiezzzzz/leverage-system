...
- Full factory implementation is blocked until the first tiny-game technical proof succeeds.

### P-003 idea-engine decision model
- 80+ = preferred build candidate
- 70–79 = prototype-only
- below 70 = reject
...
## P-003 success gate
P-003 foundation is not considered technically proven until AI successfully creates and modifies a tiny Roblox experience through the connected workflow and the result is playable in Roblox Studio without repeated manual code copy/paste.
